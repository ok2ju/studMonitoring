...
create function scheduleList(integer, timestamp, timestamp) returns setof chedule_type as $$
	select week_day as 'weekDay', classroom_number as 'classroomNumber', title,
	...
	group by week_day, classroom_number, title, classNumber, classLetter, t.name, t.surname, t.middlename
	order by 1 asc
$$ language sql;